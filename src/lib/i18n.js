...
const dict = {
  ja: {
    ...
    sentAt: '送信しました（{{time}}）',
    voiceSentToast: '✅録音完了🎙️家族に届けました!',
    photoSentToast: '✅写真送信完了📷家族に届けました!',
    saved: '保存済み',
  ...
  en: {
    ...
    sentAt: 'Sent ({{time}})',
    voiceSentToast: '✅ Recording sent 🎙️ Delivered to your family!',
    photoSentToast: '✅ Photo sent 📷 Delivered to your family!',
    saved: 'Saved',
