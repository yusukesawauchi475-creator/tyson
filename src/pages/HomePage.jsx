    ...
    try {
      ...
      if (result.success) {
        ...
        if (kind === 'generic_image') {
          ...
          const doRefresh = () => fetchTodayJournalMeta(getPairId(), ROLE_PARENT).then((r) => setPhotos((r.photos ?? []).filter((ph) => ph?.url)))
          doRefresh()
